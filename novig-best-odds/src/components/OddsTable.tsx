          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-gray-50/50 border-b border-gray-200">
                <TableHead className="font-semibold text-gray-900 py-4 px-6">Matchup</TableHead>
                <TableHead className="text-center font-semibold text-gray-900 py-4">Moneyline</TableHead>
                <TableHead className="text-center font-semibold text-gray-900 py-4">Spread</TableHead>
                <TableHead className="text-center font-semibold text-gray-900 py-4">Total</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
            {filteredGames.map((game) => (
              <React.Fragment key={game.id}>
                {/* Away Team Row */}
                <TableRow className="cursor-pointer hover:bg-blue-50/50 border-b border-gray-100 transition-colors" onClick={() => handleRowClick(game)}>
                  <TableCell className="py-4 px-6">
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center shadow-sm">
                        {(() => {
                          ...
                          return src ? (
                            ...
                            <Badge variant="outline" className="w-10 h-10 flex items-center justify-center p-0 text-xs font-medium">
                              {game.awayTeam.abbr}
                            </Badge>
                          )
                        })()}
